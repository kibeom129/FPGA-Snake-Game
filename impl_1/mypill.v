...
// Netlist written on Tue Dec  5 18:19:36 2023
...
//
// Verilog Description of module mypill
// module wrapper written out since it is a black-box. 
//

//

module mypill (ref_clk_i, rst_n_i, outcore_o, outglobal_o) /* synthesis cpe_box=1 */ ;
    input ref_clk_i;
    input rst_n_i;
    output outcore_o;
    output outglobal_o;
